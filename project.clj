(defproject cascalog "1.10.3-SNAPSHOT"
  ...
  :dependencies [[cascalog/cascalog-core "1.10.3-SNAPSHOT"]
                 [cascalog/cascalog-checkpoint "1.10.3-SNAPSHOT"]
                 [cascalog/cascalog-more-taps "1.10.3-SNAPSHOT"]
                 [cascalog/cascalog-math "1.10.3-SNAPSHOT"]
                 [cascalog/midje-cascalog "1.10.3-SNAPSHOT"]]
